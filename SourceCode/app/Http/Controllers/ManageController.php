...
class ManageController extends Controller
{
    ...
    {
        $cats=Category::all();
        return view('manage-posts.add',['cats'=>$cats]);
    }
    ...
    public function edit($id)
    {
        ...
        $cats=Category::all();
        $data=Post::find($id);
        return view('manage-posts.edit',['cats'=>$cats,'data'=>$data]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('manage/'.$id.'/edit')->with('success','Data has been updated');
    }
    ...
    public function destroy($id)
    {
     ...
     function save_post_form(){
        $cats=Category::all();
        return view('manage-posts.index',['cats'=>$cats]);
    }
    ...
    function save_post_data(Request $request){
        ...
        return redirect('manage')->with('success','Post has been added');
    }
    ...
    function manage_posts(Request $request){
        ...
        return view('manage-posts.index',['data'=>$posts]);
    }
